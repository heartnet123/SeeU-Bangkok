...
export function ItineraryColumn({ trip, onEditTrip, isLoading = false }: Props) {
  // Loading state
  if (isLoading) {
    return (
      <aside className="flex flex-col gap-4 h-full" role="complementary" aria-label="Trip itinerary">
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2">
        <h2 className="text-xl font-bold text-slate-800 truncate pr-2" title={trip.name}>
          {trip.name}
        </h2>
              ...
              <CardContent className="p-3 flex items-start gap-3">
                ...
                <div className="flex flex-col items-center gap-1 pt-1">
                  ...
                  <button
                    ...
                    tabIndex={0}
                  >
                    <GripVertical className="w-5 h-5 text-slate-300 hover:text-slate-400" aria-hidden="true" />
                  </button>
                </div>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-slate-500 mt-1 line-clamp-1" title={stop.address}>
                    {stop.address}
                  </p>
